...
description: >-
  ...
  smoke tests, and scaffolding. Use with Rogue Asset Store MCP packages.
---
...
- plus design/browser packages under the `rogue-asset-mcp` topic

## Procedure

1. List MCPs allowed for the team (do not install everything). Prefer Ready packages on [Rogue Asset Store](https://rogue-dev-studio.github.io/rogue-asset-store/).
